...
const Footer = () => {
    ...
    return (
        <footer className="footer footer-center py-10 px-3 md:py-14 gap-7 md:gap-8 bg-[#3871c113]">
            ...
            <aside>
                <p>Copyright © 2023 - All right reserved by QuillAcademy. Made with love by <span className="font-semibold">Junayed Noman.</span></p>
            </aside>
        </footer>
    );
};
